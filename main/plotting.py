...
def plot_organism(x1, y1, theta, ax):
    ...
    circle = Circle([x1,y1], 0.05, edgecolor = 'g', facecolor = 'orange', zorder=8)
...
def plot_superfood(x1, y1, ax):

    circle = Circle([x1,y1], 0.03, edgecolor = 'darkslateblue', facecolor = 'red', zorder=5)
    ax.add_artist(circle)
    
    pass

def plot_poison(x1, y1, ax):

    circle = Circle([x1,y1], 0.03, edgecolor = 'darkslateblue', facecolor = 'lightgreen', zorder=6)
    ax.add_artist(circle)
